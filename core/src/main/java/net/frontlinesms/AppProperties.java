...
//> PROPERTY STRINGS
	...
	/**Fabaris_a.zanchi Property key (String): the internal version of the whole FrontlineSMS release */
...
//> DEFAULT VALUES
	...
	//Fabaris_Raji and Fabaris_Maria
	private static final String DEFAULT_DATABASE_CONFIG_PATH = "sqlserver.database.xml";
        
        public static final String WEB_SERVER_IMAGES_PATH = "webServer.imagesPath";
...
//> ACCESSORS
	...
	public String getInternalVersion() {
		return "0.0.31"; // super.getProperty(KEY_INTERNAL_VERSION);
	}
	...
	public void setUserEmail(String userEmail) {
        ...
        public String getWebServerImagesPath() {
		return super.getProperty(WEB_SERVER_IMAGES_PATH, "");
	}
	public void setWebServerImagesPath(String imagePath) {
		super.setProperty(WEB_SERVER_IMAGES_PATH, imagePath);
	}

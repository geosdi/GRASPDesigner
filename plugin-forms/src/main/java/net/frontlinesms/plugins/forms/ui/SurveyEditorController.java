...
public class SurveyEditorController {
	...
	public void addNewSurveyWithName(String surveyName) {
	 ...
	 * @param sur
	 */
	public void copySurvey(Survey sur) {
	...
	public void copySurveyWithName(Survey sur, String name) throws Exception {
		Survey cloned = sur.clone();
		if (current.getFormId() != null) {
